...
import BuilderSimulation from '@/core/patterns/builder/presentation/BuilderSimulation';
import BuilderDocs from '@/content/patterns/builder.mdx';
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        <header className="mb-12 text-center">
          ...
          <StatusButton patternSlug="builder" />
        </header>
