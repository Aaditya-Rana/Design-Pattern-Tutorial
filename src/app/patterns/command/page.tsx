...
import CommandSimulation from '@/core/patterns/command/presentation/CommandSimulation';
import CommandDocs from '@/content/patterns/command.mdx';
            ...
            <div className="container mx-auto px-4 py-8 max-w-5xl">
                <header className="mb-12 text-center">
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-6">
                        Encapsulate requests as objects, enabling undo/redo and request queuing.
                    </p>
                    <StatusButton patternSlug="command" />
                </header>
