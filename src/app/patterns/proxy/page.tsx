...
import ProxySimulation from '@/core/patterns/proxy/presentation/ProxySimulation';
import ProxyDocs from '@/content/patterns/proxy.mdx';
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        <header className="mb-12 text-center">
          ...
          <StatusButton patternSlug="proxy" />
        </header>
